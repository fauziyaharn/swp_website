...
# import the backend module we previously modified (lazy init + ensure_initialized)
try:
    import importlib
    ts_app = importlib.import_module('app')
except Exception as e:
    # fallback: attempt to import as package
    try:
...
def process_endpoint():
    ...
    # prefer non-blocking warmup; if not initialized, try to initialize synchronously
    ...
    try:
        ...
        # assistant reply: reuse helper if exists
